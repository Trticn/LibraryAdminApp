...
import { changeUsername, changeStatus, useUpdateUserMutation} from "../store";
import Button from "./Button";
import { useToast } from "../context/ToastContext";

function UsersEdit({user,closeModal}) {
  ...
  const handleSubmit = async (e) => {
        ...
        try {
            await updateUser({
             ...user,username,active:status
            }).unwrap();

            showToast({ type: 'success', text: 'Član je uspešno izmenje!' });
            closeModal();
